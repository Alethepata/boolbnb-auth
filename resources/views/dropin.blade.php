...
<body>
    <div class="container my-5">
        <div class="row row-cols-2">
            <div class="col p-5">
                <div class="">Stai sponsorizzando <strong>{{$apartment->title}}</strong> con il piano <strong>{{$sponsor->plan_title}}</strong></div>
            ...
            if (xhr.readyState === 4) {
                if (xhr.status === 200) {
                    ...
                    if (response.success) {
                        ...
                        window.location.href = '/payment-success?sponsor=' + sponsor_id + '&apartment=' + apartment_id;
                    }else{
