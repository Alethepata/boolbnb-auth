                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4 row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button class="btn btn-pers" id="btn">
                                    {{ __('Registrati') }}
                                </button>
                            </div>
                        </div>
    ...
    <script>
        ...
        dateOfBirth.addEventListener('blur', function() {
            ...
            function validateDate(firstvalue, secondvalue, thirdvalue) {
                ...
                let message;
                if ((year - firstvalue) > 18 || (year - firstvalue) == 18 && month >= secondvalue && day >=
                    thirdvalue) {
                    return true;
                } else {
                    return false;
        ...
        btn.addEventListener('click', function() {
            ...
            if (password.value.length > 0 && passwordConfirm.value.length > 0 && email.value.length > 0 && password
